        ...
        innerCreate = function (){
          obj.trigger('create', function (createDone){
            obj.trigger('save', function (saveDone){
              ...
              this._adapter().create(modelName, this.constructor._forDB(obj.toObject(true)), function adapterCreate(err, id, rev){
                if (id) {
                  obj.__data.id = id;
                  obj.__dataWas.id = id;
...
AbstractClass.count = function count(where, cb){
  ...
  return stillConnecting(Model.schema).then(function(){
    ...
    Model.schema.adapter.count(Model.modelName, d.callback, Model._forDB(where));
